 ...
 * Nabo palette.
 *
 * `light` is taken verbatim from the design (soft daylight — pale blue-grey
 * ground, terracotta as the single accent). `dark` is a derived counterpart:
 * the design is light-only, so these values keep the same hue relationships
 * (cool blue-grey neutrals, terracotta accent lifted for contrast on dark).
 */
const light = {
  isDark: false,
  ...
  borderStrong: "rgba(22,32,43,0.12)",
...
const dark: typeof light = {
  ...
  accentSoft: "#38201A",
  accentSoftBorder: "rgba(226,105,75,0.28)",
  onAccent: "#FFFFFF",
  ...
  borderStrong: "rgba(237,241,246,0.16)",
