...
export const DEFAULT_SEARCH_AGENTS: SearchAgent[] = [
  { name: "Aarhus, under 6.500", meta: "Aarhus · instant alerts", hits: 3 },
];

export const AGENT_AREAS = ["Aarhus", "Aarhus C", "Trøjborg", "Frederiksbjerg", "Åbyhøj", "Risskov", "Brabrand"];
export const AGENT_FEATURES = ["Room", "Studio", "Apartment", "House"];
export const AGENT_FREQUENCIES = ["Instantly", "Saved only"];
