...
export const SwipeDeck = React.forwardRef<SwipeDeckHandle, { applicant: Applicant; onReview: (shortlisted: boolean) => void }>(
  function SwipeDeck({ applicant, onReview }, ref) {
    ...
    const responder = React.useMemo(
      () =>
        PanResponder.create({
          onStartShouldSetPanResponder: () => !committingRef.current,
